...
[Script]
Sub_info = type=generic,timeout=10,script-path=https://raw.githubusercontent.com/Marcus0605/GlobalNetworkRules/main/surge_subinfo_pannel.js,script-update-interval=0,argument=url=[URL encode 后的机场节点链接]&reset_day=1&title=AmyInfo&icon=bonjour&color=#007aff
...
(async () => {
  ...
  let content = [`用量：${bytesToSize(used)} | 剩余：${bytesToSize(total-used)}`];
